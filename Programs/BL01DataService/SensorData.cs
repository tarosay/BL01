...
namespace BL01DataService
{
    ...
    {
        // センサーデータを保持するクラス
        public string DateTime { get; set; }          //測定時刻
        ...
        public override string ToString()
        {
            return $"DateTime: {DateTime}, Temperature: {Temperature}℃, Humidity: {Humidity}%, Illuminance: {Illuminance}lx, UV: {UV}, Pressure: {Pressure}hPa, " +
